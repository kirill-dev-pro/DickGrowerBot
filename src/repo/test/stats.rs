...
async fn test_all() {
    ...
    dicks
        .create_or_grow(uid, &ChatIdPartiality::Specific(chat_id_1.clone()), 10)
        .await
        .expect("couldn't grow the dick in the first chat");
    dicks
        .create_or_grow(uid, &ChatIdPartiality::Specific(chat_id_2.clone()), 20)
        .await
    ...
    dicks
        .create_or_grow(uid, &ChatIdPartiality::Specific(chat_id_1), -20)
        .await
        .expect("couldn't shrink the dick in the first chat");
    dicks
        .create_or_grow(uid, &ChatIdPartiality::Specific(chat_id_2), -40)
        .await
